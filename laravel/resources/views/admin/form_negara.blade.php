        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-8 mx-auto">
                    <div class="card">
                        <form class="form-horizontal" method="POST" action="{{ route('store_negara') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="file"
                                            class="form-control @error('negara_image') is-invalid @enderror"
                                            name="negara_image" required>
                                        @error('negara_image')
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control" id="benua_id" name="benua_id" required>
                                            <option value="" disabled selected>Select Benua</option>
                                            @foreach ($benuas as $benua)
                                                <option value="{{ $benua->id }}">{{ $benua->benua_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
